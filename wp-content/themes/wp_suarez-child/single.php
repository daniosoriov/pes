...
$pes_types = array( 'gallery', 'video', 'attachment' );
get_header(); ?>
<?php global $smof_data, $breadcrumb;
$layout = cshero_generetor_layout(); ?>

    <section id="primary" class="single-post-wrap blog-modern-wrap content-area<?php if ( $breadcrumb == '0' ) {
		echo ' no_breadcrumb';
	}; ?><?php echo esc_attr( $layout->class ); ?>">
        <div class="container">
            <div class="row">
                ...
                <div class="content-wrap <?php echo esc_attr( $layout->blog ); ?>">
                    <main id="main" class="site-main" role="main">
						<?php while ( have_posts() ) : the_post(); ?>
							...
							if ( in_array( $post->post_type, $pes_types ) ):
								get_template_part( 'framework/templates/single/single', 'pes' . $post->post_type );
